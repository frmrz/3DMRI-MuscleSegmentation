# -*- coding: utf-8 -*-
"""
Created on Wed Feb  8 12:48:24 2023
...
lista_vol_VL_coscia = os.listdir(in_VL_coscia)
lista_vol_VL_gamba = os.listdir(in_VL_gamba)
#%%
#PROVA DEBUG
...
def save_histogram_match(img_dir,mask_dir,ref_FSHD,ref,output_path):
...
#COSCIA
save_histogram_match(in_TR_coscia,in_TR_coscia_la,ref_FSHD_COSCIA,ref_COSCIA,out_TR_coscia)
save_histogram_match(in_VL_coscia,in_VL_coscia_la,ref_FSHD_COSCIA,ref_COSCIA,out_VL_coscia)
save_histogram_match(in_TS_coscia,in_TS_coscia_la,ref_FSHD_COSCIA,ref_COSCIA,out_TS_coscia)

# #GAMBA
save_histogram_match(in_TR_gamba,in_TR_gamba_la,ref_FSHD_GAMBA,ref_GAMBA,out_TR_gamba)
save_histogram_match(in_VL_gamba,in_VL_gamba_la,ref_FSHD_GAMBA,ref_GAMBA,out_VL_gamba)
save_histogram_match(in_TS_gamba,in_TS_gamba_la,ref_FSHD_GAMBA,ref_GAMBA,out_TS_gamba)
